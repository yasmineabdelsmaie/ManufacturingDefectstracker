...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ManufacturingDefectsTraking.Android.dll" comes first in this list. */
		"ManufacturingDefectsTraking.Android.dll",
		"DryIoc.dll",
		"Essential.Interfaces.dll",
		"FormsViewGroup.dll",
		"ManufacturingDefectsTraking.dll",
		"Plugin.Media.dll",
		"Prism.dll",
